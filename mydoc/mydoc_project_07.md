...
3. Download FASTQ files of your project with `getSRAfastq` to `/bigdata/gen242/shared/<project_name>/data`. Replace `project_name` with your the name of your course project. It should be
