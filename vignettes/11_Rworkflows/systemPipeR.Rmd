...
<!--
    ...
    <a target="_blank" href="https://github.com/tgirke/manuals/tree/master/mydoc//vignettes/11_Rworkflows/systemPipeR.Rmd" class="btn btn-default githubEditButton" role="button"><i class="fa fa-github fa-lg"></i> Edit me</a>
