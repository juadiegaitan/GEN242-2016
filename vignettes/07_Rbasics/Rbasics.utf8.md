...
in the rendered document, one can use standard Markdown or HTML syntax, _e.g._: `<img src="myplot.png"/>`.  
...
place the citation [@Lawrence2013-kt] inline in the text and add the corresponding
