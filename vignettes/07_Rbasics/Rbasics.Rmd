...
<!--
    ...
    <a target="_blank" href="https://github.com/tgirke/manuals/tree/master/mydoc//vignettes/07_Rbasics/Rbasics.Rmd" class="btn btn-default githubEditButton" role="button"><i class="fa fa-github fa-lg"></i> Edit me</a>
